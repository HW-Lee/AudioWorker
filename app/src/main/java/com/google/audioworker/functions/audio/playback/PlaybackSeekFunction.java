...
public class PlaybackSeekFunction extends PlaybackFunction {
    ...
    private static final String TAG = Constants.packageTag("PlaybackSeekFunction");

    private static final String ATTR_TYPE = PlaybackStartFunction.ATTR_TYPE;
    private static final String ATTR_PLAYBACK_ID = PlaybackStartFunction.ATTR_PLAYBACK_ID;
    private static final String ATTR_SEEK_POSITION_MS = "seek-position-ms";
    private static final String[] ATTRS = {ATTR_TYPE, ATTR_PLAYBACK_ID, ATTR_SEEK_POSITION_MS};
    ...
    private Parameter<Integer> PARAM_SEEK_POSITION_MS =
            new Parameter<>(ATTR_SEEK_POSITION_MS, true, 0);
    private Parameter[] PARAMS = {PARAM_TYPE, PARAM_PLAYBACK_ID, PARAM_SEEK_POSITION_MS};
