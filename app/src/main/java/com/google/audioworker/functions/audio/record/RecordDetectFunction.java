...
public class RecordDetectFunction extends RecordFunction {
    private static final String TAG = Constants.packageTag("RecordDetectFunction");

    public static final String ATTR_TYPE = "type";
    public static final String ATTR_CLASS_NAME = "class";
    public static final String ATTR_CLASS_HANDLE = "class-handle";
    public static final String ATTR_PARAMS = "params";

    public static final String OP_REGISTER = "register";
    public static final String OP_UNREGISTER = "unregister";
    public static final String OP_SETPARAMS = "setparams";

    private static final String[] OPS = {OP_REGISTER, OP_UNREGISTER, OP_SETPARAMS};

    private static final String[] ATTRS = {
        ATTR_TYPE, ATTR_CLASS_NAME, ATTR_CLASS_HANDLE, ATTR_PARAMS
    };
    ...
    private Parameter[] PARAMS = {PARAM_TYPE, PARAM_CLASS_NAME, PARAM_CLASS_HANDLE, PARAM_TPARAMS};
    ...
    private boolean checkType(String type) {
        for (String op : OPS) if (op.equals(type)) return true;
