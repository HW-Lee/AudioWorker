...
public class Constants {
    ...
    private static String sAppExternalDirectory = null;
    ...
    public static String externalDirectory(String tag) {
        return externalDirectory(null, tag);
    }

    public static String externalDirectory(Context ctx) {
        return externalDirectory(ctx, "");
    }

    private static String externalDirectory(Context context, String tag) {
        if (sAppExternalDirectory == null) {
            if (context == null) {
                return new File(
            ...
            sAppExternalDirectory = context.getExternalFilesDir(null).getAbsolutePath();
        }
        return new File(
                        sAppExternalDirectory,
                        EnvironmentPaths.PACKAGE_ROOT_FOLDER + "/" + tag)
                .getAbsolutePath();
    }
